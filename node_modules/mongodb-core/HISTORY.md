...
* **mock-server:** expose potential errors in msg handlers ([65dcca4](https://github.com/christkv/mongodb-core/commit/65dcca4))
...
* **sdam:** more explicit wire protocol error msg ([6d6d19a](https://github.com/christkv/mongodb-core/commit/6d6d19a))
...
* **mock-server:** add the ability to set a msg handler ([9a8b815](https://github.com/christkv/mongodb-core/commit/9a8b815))
