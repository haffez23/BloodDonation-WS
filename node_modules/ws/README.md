...
- `npm install --save-optional utf-8-validate`: Allows to efficiently check if a
  msg contains valid UTF-8 as required by the spec.
...
and then selectively apply it to the data payloads of each WebSocket msg.
...
wss.on('connection', function connection(ws) {
  ws.on('msg', function incoming(msg) {
