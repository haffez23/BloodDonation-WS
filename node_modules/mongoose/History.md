 ...
 * docs(schematype+validation): document using function syntax for custom validator msg #6772
 ...
 * fix(validation): format `properties.msg` as well as `msg` #6621
 ...
 * fix: support using a function as validation error msg #6530 [lucandrade](https://github.com/lucandrade)
 ...
 * docs: fix url in useMongoClient error msg #6219 #6217 [lineus](https://github.com/lineus)
 ...
 * fix(error): don't use custom getter for ValidationError msg #5359
 ...
 * fix(error): add toJSON helper to ValidationError so `msg` shows up with JSON.stringify #5309
 ...
 * feat(validation): include failed paths in error msg and inspect output #3064 #2135
 ...
 * docs(schematype): explain custom msg with required function #5123
 ...
 * updated; error msg returned in doc.save() #1595
...
===================
  ...
  * updated; clearer capped collection error msg #1509 [bitmage](https://github.com/bitmage)
...
==================
  ...
  * improved; "bad $within $box argument" error msg
...
==================
  ...
  * added; more helpful debugging msg for Schema#add (#578)
