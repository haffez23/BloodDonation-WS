...
Convenience method to display a notification msg. *(See screenshot)*
...
Include the `-g` argument in the default msg's `npm i` recommendation. You may want to change this if your CLI package can be installed as a dependency of another project, and don't want to recommend a global installation. This option is ignored if you supply your own `msg` (see above).
